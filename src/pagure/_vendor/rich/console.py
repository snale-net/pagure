...
from pagure._vendor.rich._null_file import NULL_FILE

if sys.version_info >= (3, 8):
    from typing import Literal, Protocol, runtime_checkable
else:
    from pagure._vendor.typing_extensions import (
        Literal,
        Protocol,
        runtime_checkable,
    )  # pragma: no cover
...
class Console:
    ...
    def print_json(
        ...
        *,
        ...
        """
        from pagure._vendor.rich.json import JSON
                ...
                if self.is_jupyter:  # pragma: no cover
                    ...
                    if WINDOWS:
                        ...
                        if use_legacy_windows_render:
                            from pagure._vendor.rich._win32_console import LegacyWindowsTerm
                            from pagure._vendor.rich._windows_renderer import legacy_windows_render
    ...
    def export_svg(
        ...
        *,
        ...
        from pagure._vendor.rich.cells import cell_len
