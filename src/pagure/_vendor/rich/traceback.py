...
from pagure._vendor.pygments.lexers import guess_lexer_for_filename
from pagure._vendor.pygments.token import Comment, Keyword, Name, Number, Operator, String
from pagure._vendor.pygments.token import Text as TextToken
from pagure._vendor.pygments.token import Token
...
class Traceback:
    ...
    def extract(
        ...
        *,
        ...
        from pagure._vendor.rich import _IMPORT_CWD
