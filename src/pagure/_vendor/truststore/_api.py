...
if typing.TYPE_CHECKING:
    from pagure._vendor.typing_extensions import Buffer
...
def inject_into_ssl() -> None:
    ...
    try:
        import pagure._vendor.urllib3.util.ssl_ as urllib3_ssl
    ...
    try:
        from pagure._vendor.requests import adapters as requests_adapters
