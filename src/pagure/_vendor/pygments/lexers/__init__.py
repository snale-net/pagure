...
from pagure._vendor.pygments.modeline import get_filetype_from_buffer
from pagure._vendor.pygments.plugin import find_plugin_lexers
from pagure._vendor.pygments.util import ClassNotFound, guess_decode
