...
from pagure._vendor.pygments.lexer import DelegatingLexer, RegexLexer, include, \
    bygroups, using, default, words, combined, this
from pagure._vendor.pygments.util import get_bool_opt, shebang_matches
from pagure._vendor.pygments.token import Text, Comment, Operator, Keyword, Name, String, \
    Number, Punctuation, Generic, Other, Error, Whitespace
from pagure._vendor.pygments import unistring as uni
