...
class ConfigurationCommand(Command):
    ...
    def open_in_editor(self, options: Values, args: list[str]) -> None:
        ...
        if fname is None:
            raise PagureError("Could not determine appropriate file.")
        elif '"' in fname:
        ...
        try:
            ...
            raise PagureError(f"Editor Subprocess exited with exit code {e.returncode}")
    ...
    def _save_configuration(self) -> None:
        ...
        try:
            ...
            raise PagureError("Internal Error.")
    ...
    def _determine_editor(self, options: Values) -> str:
        if options.editor is not None:
            ...
            raise PagureError("Could not determine editor to use.")
