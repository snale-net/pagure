...
from pagure._vendor.packaging import specifiers
from pagure._vendor.packaging.tags import Tag
from pagure._vendor.packaging.utils import canonicalize_name
from pagure._vendor.packaging.version import InvalidVersion, _BaseVersion
...
from pagure._internal.index.collector import LinkCollector, parse_links
from pagure._internal.models.candidate import InstallationCandidate
...
from pagure._internal.req import InstallRequirement
...
from pagure._internal.utils.misc import build_netloc
from pagure._internal.utils.packaging import check_requires_python
from pagure._internal.utils.unpacking import SUPPORTED_EXTENSIONS

if TYPE_CHECKING:
    from pagure._vendor.typing_extensions import TypeGuard
...
class PackageFinder:
    ...
    def find_requirement(
        ...
        def _format_versions(cand_iter: Iterable[InstallationCandidate]) -> str:
            ...
            # handle different vendoring sources from pagure and pkg_resources.
