...
from pagure._internal.utils.misc import HiddenText, display_path, hide_url
from pagure._internal.utils.subprocess import make_command
from pagure._internal.vcs.versioncontrol import (
    AuthInfo,
    RemoteNotFoundError,
    RemoteNotValidError,
    RevOptions,
