...
from pagure import __file__ as pagure_location
from pagure.cli.spinners import open_spinner
from pagure._internal.locations import get_platlib, get_purelib, get_scheme
from pagure._internal.metadata import get_default_environment, get_environment
from pagure._internal.utils.logging import VERBOSE
...
def get_runnable_pip() -> str:
    ...
    environment.
    """
    source = pathlib.Path(pagure_location).resolve().parent
