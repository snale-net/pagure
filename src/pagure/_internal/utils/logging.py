...
from pagure._internal.utils._log import VERBOSE, getLogger
from pagure._internal.utils.compat import WINDOWS
from pagure._internal.utils.deprecation import DEPRECATION_MSG_PREFIX
from pagure._internal.utils.misc import ensure_dir
...
def setup_logging(verbosity: int, no_color: bool, user_log_file: str | None) -> int:
    ...
    handler_classes = {
        "stream": "pagure._internal.utils.logging.RichPipStreamHandler",
        "file": "pagure._internal.utils.logging.BetterRotatingFileHandler",
    }
    ...
    logging.config.dictConfig(
        {
            ...
            "filters": {
                "exclude_warnings": {
                    "()": "pagure._internal.utils.logging.MaxLevelFilter",
                ...
                "exclude_subprocess": {
                    "()": "pagure._internal.utils.logging.ExcludeLoggerFilter",
                    "name": subprocess_logger.name,
                },
            },
            "formatters": {
