...
from pagure._vendor.resolvelib.providers import AbstractProvider
...
if TYPE_CHECKING:
    from pagure._vendor.resolvelib.providers import Preference
    from pagure._vendor.resolvelib.resolvers import RequirementInformation
