...
from pagure._vendor.rich import reconfigure
from pagure._vendor.rich import traceback as rich_traceback

from pagure.cli import cmdoptions
from pagure.cli.command_context import CommandContextMixIn
from pagure.cli.parser import ConfigOptionParser, UpdatingDefaultsHelpFormatter
from pagure.cli.status_codes import (
    ERROR,
...
class Command(CommandContextMixIn):
    ...
    def _run_wrapper(self, level_number: int, options: Values, args: list[str]) -> int:
        ...
        try:
            ...
            return status
        except DiagnosticPagureError as exc:
