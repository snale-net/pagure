...
prepend-path LIBRARY_PATH $prefix/n${name["$group$index"]}/hdf5.110/openmpi110/$compilo/fortran/4.4.4/lib
...
prepend-path LIBRARY_PATH $prefix/n${name["$group$index"]}/hdf5.110/openmpi300/$compilo/fortran/4.4.4/lib
...
prepend-path LIBRARY_PATH $prefix/n${name["$group$index"]}/hdf5.110/mpich321/$compilo/fortran/4.4.4/lib
